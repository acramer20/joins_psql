...
SELECT o.first_name, o.last_name, COUNT(*) AS total_cars FROM owners o JOIN vehicles v ON v.owner_id = o.id GROUP BY (o.first_name, o.last_name) ORDER BY total_cars;
...
SELECT o.first_name, o.last_name, ROUND(AVG(v.price)), COUNT(v.owner_id) FROM owners o JOIN vehicles v ON v.owner_id = o.id GROUP BY (o.first_name, o.last_name) HAVING COUNT(v.owner_id) > 1 AND ROUND(AVG(v.price)) > 10000 ORDER BY o.first_name DESC;